<template>
  <div
    class="group relative cursor-pointer overflow-hidden rounded-3xl bg-white/50 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl transition-all duration-700 hover:scale-[1.02]"
    v-motion
